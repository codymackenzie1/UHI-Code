/* Cody Mackenzie, 19010208, Pontoon Card Game Script.*/
  ...
  function Game() 
  {
    ...
    while (counter <= 5)
    {
      ...
      var drawStick = ["draw", "stick"];
      
      //Asking the user if they would wish to draw a card or stick.
      drawStick = prompt("Do you wish to draw a card. If so please enter draw, or stick."); 
      
      //Starting a if statement. If the user enters 'draw' this will give and display a random card to the user. 
      if (drawStick = "0")
      { 
          //Declaring the variable 'Card' as a random card.
          ...
          //Displaying the text on the users screen, in the form of an alert.
          alert("Your card is " + card + "." + " This makes your current total " + userplayer + "." + " You have " + counter + " out of 5 cards. ");
      }   
      /*If the user enters stick, this will display a message saying "You stand". 
      Indicating that the user is happy with their hand and wishes to refrain from drawing any other cards.*/ 
      else if (drawStick = "1")
      {
        ...
        //Logging the text "You stand" on the html page.
        document.write("You Stand. ");
        
        //Displaying the text "You stand" on the users display
        alert("You Stand. ");
      ...
      //If the user enters anything other than 'draw' or 'stick'. Then they will get an error messages telling them to retry. 
      else 
      {
        //Sending the text "You have inputed the incorrect word, please retry and enter 'draw' or 'stick'"
        prompt("*ERROR*, You have inputed the incorrect word, please retry and enter 'draw' or 'stick' ");
